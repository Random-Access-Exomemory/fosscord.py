...
``fosscord.ext.tasks`` -- asyncio.Task helpers
====================================================
...
A simple background task in a :class:`~fosscord.ext.commands.Cog`:

.. code-block:: python3

    from fosscord.ext import tasks, commands
...
.. attributetable:: fosscord.ext.tasks.Loop

.. autoclass:: fosscord.ext.tasks.Loop()
    :members:
...
.. autofunction:: fosscord.ext.tasks.loop
