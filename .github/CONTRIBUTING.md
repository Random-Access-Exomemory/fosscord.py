...
- The official support server: https://fosscord.gg/UCXwPR7Pew
- The Fosscord API server under #python_fosscord-py: https://fosscord.gg/fosscord-api
- [The FAQ in the documentation](https://pycord.readthedocs.io/en/latest/faq.html)
- [StackOverflow's `fosscord.py` tag](https://stackoverflow.com/questions/tagged/fosscord.py)
...
3. Make sure to provide enough information to make the issue workable. The issue template will generally walk you through the process but they are enumerated here as well:
    ...
    - Tell us **information about your environment**. What version of fosscord.py are you using? How was it installed? What operating system are you running on? These are valuable questions and information that we use.
