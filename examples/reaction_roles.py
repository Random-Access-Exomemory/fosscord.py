...
class MyClient(fosscord.Client):
    ...
    async def on_raw_reaction_add(self, payload: fosscord.RawReactionActionEvent):
    ...
    async def on_raw_reaction_remove(self, payload: fosscord.RawReactionActionEvent):
