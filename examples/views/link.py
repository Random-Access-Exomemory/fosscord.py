...
class Google(fosscord.ui.View):
    def __init__(self, query: str):
        super().__init__()
        # we need to quote the query string to make a valid url. Fosscord will raise an error if it isn't valid.
        ...
        self.add_item(fosscord.ui.Button(label="Click Here", url=url))
