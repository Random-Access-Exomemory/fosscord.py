...
async def mention(ctx, member: fosscord.Member):  # user commands return the member
...
async def show_id(ctx, message: fosscord.Message):  # message commands return the message
